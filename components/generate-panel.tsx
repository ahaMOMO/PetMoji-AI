...
import { Loader2, Download, Share2, X, Smile, Dog, Palette, Type, ImageIcon, ArrowLeft } from "lucide-react"
      ...
      <DialogContent className="max-w-4xl p-6">
        <DialogHeader className="flex flex-row items-center justify-between pb-2">
          <div className="flex items-center gap-2">
            ...
            <DialogTitle className="text-xl font-bold">{t("generate.title")}</DialogTitle>
          </div>
